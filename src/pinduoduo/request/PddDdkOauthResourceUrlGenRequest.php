 ...
 * @link       https://open.pinduoduo.com/application/document/api?id=pdd.ddk.oauth.resource.url.gen
 **/
class PddDdkOauthResourceUrlGenRequest extends RequestBase
{
     ...
     * @var string
     */
    Protected $apiName = 'pdd.ddk.oauth.resource.url.gen';
     ...
     * @return PddDdkOauthResourceUrlGenRequest
     * @var string 
     * @isMust 非必填
     */
