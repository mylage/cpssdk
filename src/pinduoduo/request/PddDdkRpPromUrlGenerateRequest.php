 ...
 **/
class PddDdkRpPromUrlGenerateRequest extends RequestBase
{
     ...
     * @var string
     */
    Protected $apiName = 'pdd.ddk.rp.prom.url.generate';
     ...
     * @return PddDdkRpPromUrlGenerateRequest
     * @var int 
     * @isMust 非必填
     */
    ...
    /**
     * 营销工具类型，必填：-1-活动列表，0-红包(需申请推广权限)，2–新人红包，3-刮刮卡，5-员工内购，10-生成绑定备案链接，12-砸金蛋，13-一元购C端页面，14-千万补贴B端页面，15-充值中心B端页面，16-千万补贴C端页面，17-千万补贴投票页面，18-一元购B端页面，19-多多品牌星选B端页面，20-多多品牌星选C端页面，23-超级红包，24-礼金全场N折活动B端页面，25-品牌优选B端页面，26-品牌优选C端页面，27-带货赢千万，28-满减券活动B端页面，29-满减券活动C端页面，30-免单B端页面，31-免单C端页面；红包推广权限申请流程链接：https://jinbao.pinduoduo.com/qa-system?questionId=289
     * @return PddDdkRpPromUrlGenerateRequest
     * @var int 
     * @isMust 非必填
     */
