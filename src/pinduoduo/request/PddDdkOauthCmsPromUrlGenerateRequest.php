 ...
 * 生成商城推广链接接口
 * @ApiDescr   生成商城推广链接接口
 * @link       https://open.pinduoduo.com/application/document/api?id=pdd.ddk.oauth.cms.prom.url.generate
 **/
class PddDdkOauthCmsPromUrlGenerateRequest extends RequestBase
{
     ...
     * @var string
     */
    Protected $apiName = 'pdd.ddk.oauth.cms.prom.url.generate';
     ...
     * @return PddDdkOauthCmsPromUrlGenerateRequest
     * @var int 
     * @isMust 非必填
     */
